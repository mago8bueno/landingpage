...
export default function Home() {
  return (
    <>
      {/* HERO – Carolina Duarte, dueña saturada */}
      <main className='min-h-screen flex items-center justify-center px-4 bg-gradient-to-b from-black via-slate-950 to-black'>
        <div className='max-w-3xl text-center space-y-6'>
          ...
          >
            PARA DUEÑAS DE BOUTIQUES DE ROPA EN LATAM QUE VIVEN DE INSTAGRAM Y WHATSAPP
          </motion.p>
          ...
          >
            Tu tienda vende más con las mismas clientas.
          </motion.h1>
          ...
          >
            Si hoy vives del WhatsApp y de lo que haga Instagram, este sistema pone orden:
            detecta qué clientas están desapareciendo y te dice qué hacer cada día en menos de 5 minutos.
          </motion.p>
      ...
      {/* BLOQUE 2 – Resumen visual del sistema */}
      <DashboardPreview />

      {/* BLOQUE 3 – Dolor real de la dueña saturada */}
      <PainSection />

      {/* BLOQUE 4 – Cómo LoyalLight se encarga del trabajo sucio */}
      <SolutionSection />
    </>
  );
}
